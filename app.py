...
def calculate_system():
    ...
    # Simpan detail kalkulasi analisa
...
# --- 3. Fungsi Helper Excel (Import & Template Generator) ---

def generate_excel_template(data_dict, sheet_name):
    """Membuat file Excel template di memory untuk didownload"""
    output = io.BytesIO()
    ...
    with tabs[1]:
        ...
        with st.expander("📂 Import / Download Template Volume"):
            ...
            with col_dl:
                ...
                # Buat Data Template
                template_rab_data = {
                    'Uraian_Pekerjaan': ['Contoh: Pondasi Batu Kali', 'Contoh: Beton K-250'],
                    'Kode_Analisa_Ref': ['A.2.2.1', 'A.4.1.1'],
                    'Volume': [100, 50]
                }
    ...
    with tabs[3]:
        ...
        with st.expander("📂 Import / Download Template Harga"):
            ...
            with col_dl_p:
                ...
                # Buat Data Template
                template_price_data = {
                    'Komponen': ['Semen Portland', 'Pasir Beton (Contoh)'],
                    'Harga_Dasar': [1300, 300],
                    'Satuan': ['kg', 'kg']
                }
